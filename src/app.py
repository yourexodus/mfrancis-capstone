    ...
    html.Div(
        ...
        children=[
            ...
            html.A( 'Final_capstone_Part_I_Getting_the_Data.ipynb' ,
                    href="https://git.generalassemb.ly/mfrancis/unit-4-capstone/blob/main/Final_capstone_Part_I_Getting_the_Data.ipynb" ,
                    style={'gridArea': "link2"} ) , html.Br() ,
            html.A( 'Final_capstone_Part_II_Modeling.ipynb' ,
                    href="https://git.generalassemb.ly/mfrancis/unit-4-capstone/blob/main/Final_capstone_Part_II_Modeling.ipynb" ,
